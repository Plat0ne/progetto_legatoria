<script>
	...
	function SendData() {
		...
		$.ajax({
			url: 'ajax/ajax_lavorazioni_cucitura.php',
			type: 'POST',
			data: {
				aggiunta_riga : "True",
			...
			success: function(response) {
				...
				var table = $('#datatable-lavorazioni_cucitura').DataTable();
				...
				var newRow = [
					...
					formValues['colpi_inizio'], // Fogli Da Lavorare
					formValues['colpi_fine'], // Fogli Lavorati
