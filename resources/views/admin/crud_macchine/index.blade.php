...
<div >
    ...
    <div class="container datatable-generic">
        ...
        <button class="btn btn-primary mb-3" type="button" data-toggle="modal" data-target="#macchineModal" >Aggiungi macchina</button>
        ...
        <table id="datatable-generic" class="table table-dark">
            ...
            <tbody id="macchineTable">
                ...
                <tr id="row-{{ $m->id_macchina }}">
                    ...
                    <td>
                        <button class="modificaButton btn btn-sm btn-warning text-dark" data-id="{{ $m }}" data-toggle="modal" data-target="#editModal">Modifica</button>
  ...
  <div class="modal-dialog">
    ...
    <form id="macchineForm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button id="aggiugni_macchina" type="button" class="btn btn-success">Salva</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>
        </div>
      </div>
    </form>
