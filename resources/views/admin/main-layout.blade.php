...
<html lang="it">
    <head>
        ...
        <!-- Font personalizzati per questo template-->
        @vite(['resources/css/app.css', 'resources/css/font.css', 'resources/css/cards.css', 'resources/css/delete.css', 'resources/css/edit.css', 'resources/css/click.css', 'resources/css/fill.css', 'resources/css/cancel.css', 'resources/css/save.css', 'resources/css/close.css', 'resources/js/app.js'])
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold;">Vuoi uscire?</h5>
                    ...
                    <div class="modal-footer">
                        <button class="button-arrow--sand" type="button" data-dismiss="modal">Annulla</button>
